## =============================================================================================
## Pipeline with capability (option) to 
## - Augment data (Additive Noise, Pitch Shifting, Time Stretching)
## - Split train/val/test set
## - Extract features (MFCC, Delta, Delta-Delta, ZCR, RMS Energy)
## - Aggregate features accordingly depending on model needs (Trad ML vs DL)
## - Output separate datasets depending on model needs (Trad ML vs DL)
## =============================================================================================
...
SEED = 42
OUTPUT_DIR = "../datasets_combined_no_augmented"
AUGMENT = False  # Toggle augmentation on/off
